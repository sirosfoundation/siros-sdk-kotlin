...
/**
 * [StockEntryBuilder.splitMdocClaimKey] - the mdoc namespace/element split that
 * every entry built for the stock AndroidX matcher goes through.
 *
 * These cases used to live in the sample app as `DCAPICredentialEntryBuilderTest`.
 * The builder moved into the SDK, the test did not and stopped compiling, so
 * the split had no coverage at all. It lives beside its subject now.
 */
